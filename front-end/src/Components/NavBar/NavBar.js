...
export default function Navbar() {
  ...
  return (
    <div className={`h-26 flex flex-col fixed z-50 text-xl top-1/2 ${status === 0 ? home : other} transform -rotate-90 rounded-t-3xl pl-4 pr-4 pb-10 bg-blue-200 bg-opacity-10 border-t-8 border-l-2 border-r-2 border-gray-300 backdrop-filter backdrop-blur-md backdrop-brightness-70 transition duration-200 ease-in-out hover:-translate-x-10`}>
